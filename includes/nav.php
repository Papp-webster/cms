...
<?php endif; ?>
     ...
     <img src=" <?php echo $_SESSION["user_img"]; ?>" class="img-responsive img-circle img-thumbnail" />
    <h3><?php echo $_SESSION["user_name"] ?></h3>';
    <a class="nav-item" href="/cms/includes/logout.php"><i class="fa fa-power-off"></i>
<strong>Kilépés</strong>
</a></li></a>
     ...
     $error['email'] = 'Sikertelen küldés!';
      ...
      <div class="modal-body fix">
        ...
        <form  id="registration-form" action="/cms/" autocomplete="off" method="post">
          ...
          <p class="error text-center"><?php echo isset($error['password'])?  $error['password'] : ''?> </p>
