...
$query .= "VALUES('{$post_cat_id}', '{$post_cim}','{$post_author}', '{$post_user}','{$post_date}','{$post_image}', '{$post_tartalom}', '{$post_tags}', '{$post_status}')";
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <textarea type="text" class="form-control" name="post_tartalom" id="summernote" cols="30" rows="10"></textarea>
  </div>
