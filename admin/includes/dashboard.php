                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ['Dátum', 'Összes'], <
                            ? php
                            $elements_text = ['Összes poszt', 'Aktív Posztok', 'Elutasított Posztok',
                                'Kommentek', 'Elutasított kommentek', 'Felhasználók', 'Feliratkozók',
                                'Kategóriák'
                            ];
                            $elements_count = [$post_counts, $post_public_counts, $post_draft_counts,
                                $comment_counts, $comm_elut_counts, $users_counts, $user_felirat_counts,
                                $cat_counts
                            ];
